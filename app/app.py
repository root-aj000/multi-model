...
class PredictionResult(BaseModel):
    ...
    Attributes:
        ...
        theme_confidence: Confidence for theme prediction
        sentiment_confidence: Confidence for sentiment prediction
        ...
        confidence_score: Primary prediction confidence
    ...
    confidence_score: float = Field(..., ge=0.0, le=1.0, description="Primary prediction confidence (0-1)")
    ...
    theme_confidence: Optional[float] = Field(None, ge=0.0, le=1.0)
    ...
    dominant_colour_confidence: Optional[float] = Field(None, ge=0.0, le=1.0)
    
    attention_score: Optional[str] = Field(None, description="Attention-grabbing level")
    attention_score_confidence: Optional[float] = Field(None, ge=0.0, le=1.0)
    
    trust_safety: Optional[str] = Field(None, description="Safety/trustworthiness level")
    trust_safety_confidence: Optional[float] = Field(None, ge=0.0, le=1.0)
    
    target_audience: Optional[str] = Field(None, description="Intended audience type")
    target_audience_confidence: Optional[float] = Field(None, ge=0.0, le=1.0)
    
    predicted_ctr: Optional[str] = Field(None, description="Click-through rate prediction")
    predicted_ctr_confidence: Optional[float] = Field(None, ge=0.0, le=1.0)
    
    likelihood_shares: Optional[str] = Field(None, description="Share likelihood")
    likelihood_shares_confidence: Optional[float] = Field(None, ge=0.0, le=1.0)
...
if __name__ == "__main__":
    ...
    try:
        ...
        uvicorn.run(
            "app.app:app",  # Module:app_instance
    ...
    "predictions": [
        {
            ...
            "dominant_colour": "red",
            "dominant_colour_confidence": 0.88,
            
            "attention_score": "high",
            "attention_score_confidence": 0.91,
            
            "trust_safety": "safe",
            "trust_safety_confidence": 0.85,
            
            "target_audience": "adults",
            "target_audience_confidence": 0.89,
            
            "predicted_ctr": "high",
            "predicted_ctr_confidence": 0.83,
            
            "likelihood_shares": "likely",
            "likelihood_shares_confidence": 0.86,
