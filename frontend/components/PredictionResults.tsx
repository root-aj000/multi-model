...
export default function PredictionResults({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-primary-400 to-purple-600 px-6 py-4">
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
              ...
              <div className="p-4 border-t border-gray-200">
                ...
                <div className="mt-3 flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 text-sm font-medium text-primary-600 bg-primary-400/10 rounded-full">
        ...
        <div className="border-t border-gray-200 bg-gray-50 px-6 py-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-3 text-center">
              <p className="text-2xl font-bold text-primary-400">{predictions.length}</p>
