    ...
    <div className="space-y-4">
      ...
      <div
        ...
        className={`
          ...
          ${disabled ? 'opacity-50 cursor-not-allowed' : 'hover:border-primary-400 hover:bg-primary-400/5'}
          ${isDragging ? 'border-primary-400 bg-primary-400/5' : 'border-gray-300 bg-white'}
        `}
      >
        <input
          ref={fileInputRef}
        ...
        <Upload className={`mx-auto h-12 w-12 ${isDragging ? 'text-primary-400' : 'text-gray-400'}`} />
